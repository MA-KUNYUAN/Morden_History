...
//        holder.ScoreRank.setText(myArray.get(position).getName());
//        holder.UserName.setText("$"+String.valueOf(myArray.get(position).getPriceUsd()));
//        holder.UserScore.setText(String.valueOf(myArray.get(position).getPercentChange1h())+"%");
//
//    }
//
